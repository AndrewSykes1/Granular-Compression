...
chi2o=chi2;residuals0=residuals;  % save for later

% find best diameter and width
nr=0;
deldiameter=1e99;
while((abs(deldiameter)>mindeldiameter) && (nr<maxDwnr))
...
simage([residuals.^2 residuals0.^2]); caxis([0 .25]); % Show the chi-squared images
