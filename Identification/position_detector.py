...
def cluster_3d_points(points, eps=13.0, min_samples=4):
    """
...
if __name__ == '__main__':
    ...
    output_dir = f'output_figures_{scan}'
    ...
    all_centers = detect_centers_in_stack(image_stack, output_dir)
    ...
    # Save 2D plot to output directory instead of showing
    plt.savefig(os.path.join(output_dir, '3d_particle_centers_2d.png'))
    plt.close()
    ...
    # Save interactive 3D plot as HTML inside output folder
    html_file = os.path.join(output_dir, '3d_particle_centers.html')
