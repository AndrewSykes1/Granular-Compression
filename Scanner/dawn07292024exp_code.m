...
volume_length= 16.05 / 2.54; %in inches, the length of the current compression box
...
target_folder = 'C:\Users\Lab User\Desktop\experiment data\07292024\';
mkdir(target_folder);
...
%     
    ...
    pause((188)); %timeNeeded - timeSinceMotorStart
