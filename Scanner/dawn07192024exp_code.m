...
scan_distance = 110; %in mm, the height of laser scanning
volume_length= 16.35 / 2.54; %in inches, the length of the current compression box
...
CompressionPercent= 5.0; %Relative to the "current" size of container
...
target_folder = 'C:\Users\Lab User\Desktop\experiment data\07192024\';
mkdir(target_folder);
