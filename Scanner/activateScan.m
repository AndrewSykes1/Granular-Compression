...
volHeight  = 3.90; % Height (in) of volume
...
% Compression Motor
compVelocity = 0.2;  % Speed of compression (in/s)
compPercent  = .10;  % Percent of container to compress
compStep = -floor(volLen*compPercent*512000); % Motor steps to compress said distance (steps) [1rev]=[1/10inch], [51200steps/rev],[512000steps/in]
