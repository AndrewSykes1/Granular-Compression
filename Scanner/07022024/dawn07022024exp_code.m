...
target_folder = 'C:\Users\Lab User\Desktop\experiment data\07022024\';
mkdir(target_folder);

%Prep Laser and Camera Motors
motorsetup; % (Done) creates serial objects s1, s2, s3 

%Prep Compression Cell Motor

CompSetup; %(Done)uses "CompressionSpeed" and creates serial object s4
...
for scanNumber = 1:1
    ...
    motorparam(s2,laser_forward_rpm,laser_forward_accel,laser_forward_decel,abort_decel);
