...
scan_distance = 162; %in mm, the height of laser scanning
volume_length= 15.126 / 2.54; %in inches, the length of the current compression box
...
target_folder = 'C:\Users\Lab User\Desktop\experiment data\07162024\';
mkdir(target_folder);
...
farlaser_back_targetlocation = 4000;
