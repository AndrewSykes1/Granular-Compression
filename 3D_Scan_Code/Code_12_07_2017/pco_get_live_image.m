function [errorCode,image_stack,glvar] = pco_get_live_image(imacount,glvar)
%
...
%ml_cam_type.wSize=uint16(getstructsize('PCO_CameraType'));
...
%limit allocation of memory to 3000Mbyte
...
if(errorCode)
 ...
 disp('pco_get_image_single: GetImageEx done');
end
