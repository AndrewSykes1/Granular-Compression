...
volume_length=6.025; %in inches, the length of the current compression box
pixel_width = volume_length*25.4/829; %in mm, the correspondance between pixel size and real distance
...
CompressionPercent=3; %Relative to the "current" size of container
...
target_folder = 'X:\ExperimentsRawData\CyclicCompression\Experiment_02_06_18\';
mkdir(target_folder);
...
tic
for scanNumber = 1501:numberOfScans
