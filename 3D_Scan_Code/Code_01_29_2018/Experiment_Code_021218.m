...
volume_length=6.045; %in inches, the length of the current compression box
pixel_width = volume_length*25.4/844; %in mm, the correspondance between pixel size and real distance
...
target_folder = 'X:\ExperimentsRawData\CyclicCompression\Experiment_02_13_18\';
mkdir(target_folder);
...
tic
for scanNumber = 16:numberOfScans
