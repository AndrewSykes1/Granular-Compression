...
volume_length=6.16; %in inches, the length of the current compression box
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_02_22_19\';
mkdir(target_folder);
