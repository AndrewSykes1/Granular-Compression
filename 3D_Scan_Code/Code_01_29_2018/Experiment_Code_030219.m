...
NumberOfCycles = 1000; %In number of cycles, of those the first ten and the last ten would be high resolution ones.
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_03_02_19\';
mkdir(target_folder);
