...
volume_length=6.04; %in inches, the length of the current compression box
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_10_26_18\';
mkdir(target_folder);
