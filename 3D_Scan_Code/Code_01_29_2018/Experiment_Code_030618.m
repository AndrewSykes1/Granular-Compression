...
volume_length=6.035; %in inches, the length of the current compression box
...
NumberOfCycles = 700; %In number of cycles, of those the first ten and the last ten would be high resolution ones.
...
target_folder = 'X:\ExperimentsRawData\CyclicCompression\Experiment_03_06_18\';
mkdir(target_folder);
