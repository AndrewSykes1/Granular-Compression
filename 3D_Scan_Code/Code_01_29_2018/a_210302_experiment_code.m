...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_210302\';
mkdir(target_folder);
...
[err,glvaimaqhwinfo('gentl',1)] = pco_camera_open_close(glvar);
