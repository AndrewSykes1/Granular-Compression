...
volume_length=6.05; %in inches, the length of the current compression box
pixel_width = volume_length*25.4/819; %in mm, the correspondance between pixel size and real distance
...
target_folder = 'X:\ExperimentsRawData\CyclicCompression\Experiment_01_30_18\';
mkdir(target_folder);
