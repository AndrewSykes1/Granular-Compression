...
volume_length= 5.99; %in inches, the length of the current compression box
...
CompressionSpeed = 2.0; % In mm per second
...
% target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_190722\';
% mkdir(target_folder);
