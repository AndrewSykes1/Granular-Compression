...
CompressionPercent= 1.5; %Relative to the "current" size of container
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_190710\';
mkdir(target_folder);
...
tic
for scanNumber = 705:numberOfScans
