...
volume_length= 6.01; %in inches, the length of the current compression box
...
NumberOfCycles = 0; %In number of cycles, of those the first ten and the last ten would be high resolution ones.


%Input Parameters for compression cell motion
CompressionSpeed = 0.05; % In mm per second
CompressionPercent= 0.5; %Relative to the "current" size of container
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_200225\';
mkdir(target_folder);
