...
scan_distance = 80; %in mm, the height of laser scanning
volume_length= 5.98; %in inches, the length of the current compression box
...
NumberOfCycles = 20; %In number of cycles, of those the first ten and the last ten would be high resolution ones.


%Input Parameters for compression cell motion
CompressionSpeed = 1; % In mm per second
...
% target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_190819\';
% mkdir(target_folder);
