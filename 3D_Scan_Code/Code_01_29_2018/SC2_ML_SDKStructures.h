...
//original  PCO_SC2_Hardware_DESC  Board[PCO_MAXVERSIONHW];// 622
...
//original  PCO_SC2_Firmware_DESC  Device[PCO_MAXVERSIONFW];// 642
...
//original  PCO_Single_Signal_Desc strSingeSignalDesc[NUM_MAX_SIGNALS];// Array of singel signal descriptors // 4004
  PCO_Single_Signal_Desc strSingeSignalDesc1;
  PCO_Single_Signal_Desc strSingeSignalDesc2;
  PCO_Single_Signal_Desc strSingeSignalDesc3;
  PCO_Single_Signal_Desc strSingeSignalDesc4;
  PCO_Single_Signal_Desc strSingeSignalDesc5;
  PCO_Single_Signal_Desc strSingeSignalDesc6;
  PCO_Single_Signal_Desc strSingeSignalDesc7;
  PCO_Single_Signal_Desc strSingeSignalDesc8;
  PCO_Single_Signal_Desc strSingeSignalDesc9;
  PCO_Single_Signal_Desc strSingeSignalDesc10;
  PCO_Single_Signal_Desc strSingeSignalDesc11;
  PCO_Single_Signal_Desc strSingeSignalDesc12;
  PCO_Single_Signal_Desc strSingeSignalDesc13;
  PCO_Single_Signal_Desc strSingeSignalDesc14;
  PCO_Single_Signal_Desc strSingeSignalDesc15;
  PCO_Single_Signal_Desc strSingeSignalDesc16;
  PCO_Single_Signal_Desc strSingeSignalDesc17;
  PCO_Single_Signal_Desc strSingeSignalDesc18;
  PCO_Single_Signal_Desc strSingeSignalDesc19;
  PCO_Single_Signal_Desc strSingeSignalDesc20;
...
//original  PCO_Signal  strSignal[NUM_MAX_SIGNALS];// Signal settings               // 2288
  PCO_Signal  strSignal1;
  PCO_Signal  strSignal2;
  PCO_Signal  strSignal3;
  PCO_Signal  strSignal4;
  PCO_Signal  strSignal5;
  PCO_Signal  strSignal6;
  PCO_Signal  strSignal7;
  PCO_Signal  strSignal8;
  PCO_Signal  strSignal9;
  PCO_Signal  strSignal10;
  PCO_Signal  strSignal11;
  PCO_Signal  strSignal12;
  PCO_Signal  strSignal13;
  PCO_Signal  strSignal14;
  PCO_Signal  strSignal15;
  PCO_Signal  strSignal16;
  PCO_Signal  strSignal17;
  PCO_Signal  strSignal18;
  PCO_Signal  strSignal19;
  PCO_Signal  strSignal20;
...
//original  PCO_Segment strSegment[PCO_RAMSEGCNT]; // Segment info                   // 436
  PCO_Segment strSegment1;
  PCO_Segment strSegment2;
  PCO_Segment strSegment3;
  PCO_Segment strSegment4;
  //PCO_Segment ZZstrDummySeg[6];          // Segment info dummy             // 1084
  //PCO_Segment strSegmentSoftROI[PCO_RAMSEGCNT];// Segment info SoftROI     // 1516
//original  PCO_Segment ZZstrDummySeg[14];         // Segment info dummy             // 1948
  PCO_Segment ZZstrDummySeg1;
  PCO_Segment ZZstrDummySeg2;
  PCO_Segment ZZstrDummySeg3;
  PCO_Segment ZZstrDummySeg4;
  PCO_Segment ZZstrDummySeg5;
  PCO_Segment ZZstrDummySeg6;
  PCO_Segment ZZstrDummySeg7;
  PCO_Segment ZZstrDummySeg8;
  PCO_Segment ZZstrDummySeg9;
  PCO_Segment ZZstrDummySeg10;
  PCO_Segment ZZstrDummySeg11;
  PCO_Segment ZZstrDummySeg12;
  PCO_Segment ZZstrDummySeg13;
  PCO_Segment ZZstrDummySeg14;
...
//original  void*          pSC2IFFunc[20];                                                            // 92
  void*         pSC2IFFunc1;
  void*         pSC2IFFunc2;
  void*         pSC2IFFunc3;
  void*         pSC2IFFunc4;
  ...
  void*         pSC2IFFunc19;
  void*         pSC2IFFunc20;
//original  PCO_APIBuffer strPCOBuf[PCO_BUFCNT]; // Bufferlist                                        // 892
  PCO_APIBuffer strPCOBuf1;
...
//original  PCO_APIBuffer ZZstrDummyBuf[28-PCO_BUFCNT];     // Bufferlist                                        // 2892
  PCO_APIBuffer ZZstrDummyBuf1;
...
typedef struct
{
  ...
  DWORD dwStatusFlags;                 // 0: Lens Presence 'lp',
  DWORD dwInitCounter;                 // Counts number of inits in order to reflect lens changes

  DWORD dwFNumberMinimum;              // F number queried by 'da'
  DWORD dwFNumberNumStops;
  DWORD dwFNumberMaximum;
  DWORD dwZoomRangeMin;                // Zoom range queried by 'dz'
  DWORD dwZoomRangeMax;
  DWORD dwZoomPos;
  DWORD dwLastZoomPos;
  DWORD dwApertures[50];               // Possible aperture values in f/ * 10
  DWORD dwFocalLength;                 // Last focal length got from lens

  LONG  lFocusMin;                     // Focus range queried by 'fp'
  LONG  lFocusMax;
  LONG  lFocusCurr;
...
// union not supported in matlab use highest declaration
    DWORD dwArray[32];
}PCO_Birger;
