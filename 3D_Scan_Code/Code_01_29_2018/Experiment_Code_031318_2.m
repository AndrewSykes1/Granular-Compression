...
scan_distance = 95; %in mm, the height of laser scanning
volume_length=6.075; %in inches, the length of the current compression box
...
NumberOfCycles = 1200; %In number of cycles, of those the first ten and the last ten would be high resolution ones.
...
target_folder = 'X:\ExperimentsRawData\CyclicCompression\Experiment_03_13_18\';
mkdir(target_folder);
...
tic
for scanNumber = 1580:numberOfScans
