...
volume_length=5.96; %in inches, the length of the current compression box
...
exposure_time = 200; %in ms
NumberOfCycles = 50; %In number of cycles, of those the first ten and the last ten would be high resolution ones.


%Input Parameters for compression cell motion
CompressionSpeed = 0.05; % In mm per second
CompressionPercent= 0; %Relative to the "current" size of container
...
target_folder = 'X:\ExperimentsRawData\CyclicCompressionTwoHoles\Experiment_04_10_19\';
mkdir(target_folder);
