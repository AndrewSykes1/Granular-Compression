...
scan_distance = 153; %in mm, the height of laser scanning
volume_length= 16 / 2.54; %in inches, the length of the current compression box
...
NumberOfCycles = 10; %In number of cycles, of those the first ten and the last ten would be high resolution ones.

% -------------------------------------------------------------------------
% -------------------------------------------------------------------------
%Input Parameters for compression cell motion
CompressionSpeed = 0.05; % In mm per second
CompressionPercent= 10.0; %Relative to the "current" size of container
...
target_folder = 'C:\Users\Lab User\Desktop\experiment data\07092024\';
mkdir(target_folder);
