...
%Input Save Settings
target_folder = 'X:\ExperimentRawData\CyclicCompression\Experiment_01_23_18\';
scanFolderName = 'Scan';
ImgName = 'Image';
Extension = '.tif';
...
laser_forward_targetlocations = linspace(;
...
camera_forward_targetlocations = linspace(1,;
...
for scanNumber = 1:numberOfScans
    ...
    laser_forward_targetlocations=0;
