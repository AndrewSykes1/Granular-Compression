function [errorCode,glvar] = camera_info(glvar)
%
...
%       struct     glvar
%
%does retrieve some information of the connected camera
...
text=blanks(100);
[errorCode,out_ptr,text] = calllib('PCO_CAM_SDK','PCO_GetInfoString',out_ptr,1,text,100);
...
disp(['Name is        : ',strtrim(text)]);
disp(['SerialNumber is: ',int2str(cam_type.dwSerialNumber)]);
